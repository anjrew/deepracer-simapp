...
class IMU(SensorInterface):
    ...
    def __init__(self, racecar_name, timeout=120.0):
        ...
        Args:
            ...
            because virtual event dynamic spawning for sensor can take up to 60.0 seconds to be alive.
        """
        self.imu_buffer = utils.DoubleBuffer()
    ...
    def get_state(self, block=True):
        try:
            ...
            imu_frame.append(imu_data.angular_acceleration.x)
            imu_frame.append(imu_data.angular_acceleration.y)
            imu_frame.append(imu_data.angular_acceleration.z)
